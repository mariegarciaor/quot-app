    ...
    return (
        <div class="welcome-container welcomenew">
            <div className="welcome-content col-xl-4 .col-lg-4 col-sm-8">
                <h3 className="title-3">¡Bienvenido!</h3>
                ...
                <div className="Welcomenew-buttons">
                    ...
                    <Link to="/Login"><button className="btn button-4">Inicia Sesión</button></Link>
                </div>
                <br />
                <Link to="/QuotStart"><p className="link-1" id="continuaComoInvitado">Continua como invitado</p></Link>
            </div>
        </div>
    )
}
